...
// in todo_app/test/use_case/delete_todo_use_case/delete_todo_use_case_test.dart.
...
import 'package:todo_app/model/model.dart' as _i3;
...
class MockTodoList extends _i1.Mock implements _i3.TodoList {
  ...
  @override
  _i4.Future<bool> addTodo(_i3.Todo? todo) => (super.noSuchMethod(
        Invocation.method(
          #addTodo,
          [todo],
        ),
  ...
  @override
  _i4.Future<bool> updateTodo(_i3.Todo? newTodo) => (super.noSuchMethod(
        Invocation.method(
          #updateTodo,
          [newTodo],
        ),
  ...
  @override
  _i4.Future<bool> deleteTodo(_i3.Todo? todo) => (super.noSuchMethod(
        Invocation.method(
          #deleteTodo,
          [todo],
        ),
